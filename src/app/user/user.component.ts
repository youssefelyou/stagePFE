...
import {CustomHttpRespone} from '../controller/model/custom-http-response';
import {AuthenticationService} from '../controller/service/authentication.service';
import {Router} from '@angular/router';
import {FileUploadStatus} from '../controller/model/file-upload.status';
...
export class UserComponent implements OnInit, OnDestroy {
  ...
  public onLogOut(): void {
    ...
    this.router.navigate(['/login']).then(this.menuComponent.reloadCurrentPage);
  ...
  public get isAdmin(): boolean {
    return this.getUserRole() === Role.SUPER_ADMIN || this.getUserRole() === Role.SUPER_ADMIN;
  }
  ...
  public get isOperatorBarrage(): boolean {
    return this.getUserRole() === Role.OPERATOR_BARRAGE || this.getUserRole() === Role.OPERATOR_BARRAGE;
  }

  public get isOperatorBac(): boolean {
    return this.getUserRole() === Role.OPERATOR_BAC || this.getUserRole() === Role.OPERATOR_BAC;
  }

  public get isManager(): boolean {
    return this.isAdmin || this.getUserRole() === Role.OPERATOR_BARRAGE;
  }
